...
exports.registerVoter = async function (voterId) {
  ...
  try {
    ...
    console.log(`Successfully registered voter. Use voterId ${voterId} to login above.`);
    let response = `Successfully registered voter. Use voterId ${voterId} to login above.`;
    return response;
  } catch (error) {
